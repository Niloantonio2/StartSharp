...
public class InicioPage extends PageObject {
    public static final Target LBL_DASHBOARD = Target.the("").located(By.xpath("//h1"));
    ...
    public static final Target BTN_NUEVA_UNIDAD = Target.the("").located(By.xpath("//*[contains(text(),'Nuevo Business Unit')]"));
    ...
    public static final Target BTN_NUEVA_REUNION = Target.the("").located(By.xpath("//*[contains(text(),'Nuevo Meeting')]"));
