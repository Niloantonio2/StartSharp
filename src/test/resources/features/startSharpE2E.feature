...
Característica: E2E start sharp
  ...
  Antecedentes:  inicio de sesion
   ...
   Esquema del escenario: <Escenario>
     ...
     Ejemplos:
      ...
      #| Crear unidad de negocio fallido | Reto 68          | NoExisteUnidad |
  ...
  Esquema del escenario: <Escenario>
   ...
   | Crear reunion exitoso| Reto 6           | Administration  | AutomationTest   | 123456789        | General     | 30/01/2023      | 14:20         | 30/01/2023      | 15:40      | HQ-01        | Aaron Taylor    | Amber Jenkins  | Allison Bell      |
